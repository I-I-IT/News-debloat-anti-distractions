...
Donation prompts, article tags, pictures, videos, author information, prompts for anonymous sources, self-add or promotions.
...
Also, the upward(div/section/...) method is useful to select the upward element, especially on sites with few or no descriptive class.
